  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Expert construction and property management services across Havering and Essex. CIS-registered, fully insured. 150+ projects delivered, 100+ happy clients." />
