      ...
      <div className="service-page">
        ...
        <section className="service-benefits">
          <div className="service-container">
            ...
            <p style={{ marginTop: '16px' }}>CIS-registered. Fully insured. Emergency response available 24/7. DBS-checked operatives for care sector clients. RAMS documentation provided for all works. We maintain portfolios from single HMOs to multi-site managed estates.</p>
            ...
            <div className="benefits-grid">
              {[
                ...
                { title: 'Care Home Maintenance', desc: 'CQC-compliant maintenance services with DBS-checked operatives. Full RAMS documentation for every job. We understand the regulatory requirements and operational constraints of care environments—work is scheduled to minimise disruption to residents.' },
            ...
            <div className="benefits-grid">
              {[
                ...
                { title: 'Full Documentation', desc: 'RAMS provided for all works. Photographs before and after. Job sheets signed off on completion. All documentation stored and available on request for insurance, audits, and regulatory inspections.' },
                { title: 'DBS-Checked Operatives', desc: 'All operatives working in care homes and supported living environments are DBS-checked. We maintain a register of current certificates and provide copies to clients on request.' },
              ].map((item, i) => (
                <div key={i} className="benefit-card">
                  <h3 className="benefit-title">{item.title}</h3>
                  <p className="benefit-description">{item.desc}</p>
