...
const ExtensionsPage = () => {
  ...
  return (
    <>
      ...
      <PageLayout heroTitle="Home Extensions in Havering & Romford" heroSubtitle="Quality single & double-storey extensions across Havering and Romford. CIS-registered, fully insured.">
