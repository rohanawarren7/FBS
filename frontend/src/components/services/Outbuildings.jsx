...
const Outbuildings = () => {
  const pageData = {
    ...
    metaDescription: 'Custom garden offices, studios & outbuildings in Havering, Romford & Essex. Home offices, gyms, studios. Free quotes, 15+ years experience. CIS registered.',
