...
const GuaranteedRent = () => {
  const pageData = {
    ...
    metaDescription: 'Guaranteed rent schemes for landlords in London. Hassle-free rental income with no voids. Available in Waltham Forest, Redbridge, Enfield, Newham, Barking & Dagenham.',
